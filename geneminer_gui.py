...
def geneminer_GUI():
    ...
    left_col = [
        ...
        #min max
        [sg.Text('Min:', size=(12, 1), justification='right', font=("Arial", 12)),
         sg.Input(300, key='-min-', size=(12, 1), font=("Arial", 12), expand_x=False,
                  tooltip="The minimum length of a gene  [default=300]"),
         sg.Text('Max:', size=(8, 1), justification='right', font=("Arial", 12)),
         sg.Input(5000, key='-max-', size=(12, 1), font=("Arial", 12), expand_x=True,
                  tooltip="The maximum length of a gene [default=5000]"),
         ],

        # Boundaty threads
        [sg.Text('Boundary:', size=(12, 1), justification='right', font=("Arial", 12)),
         sg.Input(75, key='-b-', size=(12, 1), font=("Arial", 12), expand_x=False,
         ...
         sg.Input("auto", key='-t-', size=(12, 1), font=("Arial", 12), expand_x=True,
        ...
        [sg.Text('Bootstrap :', size=(12, 1), justification='right', font=("Arial", 12)),
         sg.Input(10, key='-bn-', size=(12, 1), font=("Arial", 12), expand_x=False, readonly=False,
