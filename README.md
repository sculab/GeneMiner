...
**Cite:** Pulin Xie, Yongling Guo, Yue Teng, Wenbin Zhou, Yan Yu. 2024. GeneMiner: a tool for extracting phylogenetic markers from next-generation sequencing data. Molecular Ecology Resources. Accepted

**NOTE:** We have specifically developed a graphical interface version, **EasyMiner**, for **Windows** and **macOS**. Please visit: [GitHub](https://github.com/sculab/EasyMiner) or [Gitee](https://gitee.com/sculab/EasyMiner) for details.
...
We have specifically developed a graphical interface version, **EasyMiner**, for **Windows** and **macOS**. Please visit: [GitHub](https://github.com/sculab/EasyMiner) or [Gitee](https://gitee.com/sculab/EasyMiner) for details.
