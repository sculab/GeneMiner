...
We have specifically developed a graphical interface version, **EasyMiner**, for **Windows**. Please visit: [GitHub](https://github.com/sculab/EasyMiner) or [Gitee](https://gitee.com/sculab/EasyMiner) for details.
