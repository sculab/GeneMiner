...
We have developed **GeneMiner2**, a comprehensive analysis tool for the entire workflow from NGS raw data to phylogenetic tree construction, featuring a sophisticated graphical interface (currently supporting **Windows**, with macOS support coming soon). Please visit: [GitHub](https://github.com/sculab/EasyMiner) or [Gitee](https://gitee.com/sculab/EasyMiner) for details.
